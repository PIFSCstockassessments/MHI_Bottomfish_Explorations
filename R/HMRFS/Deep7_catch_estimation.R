...
i1 = read.sas7bdat("./MRIP_Ifiles_HI/i1.sas7bdat", debug = TRUE) # trip header data
...
official_total_catch_proportion_kept = array(c(NA, 0, 0, NA, 11, 0, 100, 0, 100, 16, 15, 40, 74, 0, NA, NA, NA, NA, NA,
                                               ...
                                               NA, 0, 0, NA, 60, 47, 0, 0, 0, 78, 0, 100, 82, 0, NA, NA, NA, NA, NA) / 100, dim = c(n_years, n_species)) # no values from 2003 or after 2016
