...
temp_out=temp_out[temp_out$GEAR==3,] #871002   records of only gear 3 records
write.csv(mhidata3,"C:\\Users\\John.Syslo\\Documents\\2023 Deep 7\\Raw FRS depredation\\ForGroupCpueAnalysis_gear3Step3_2020_2021_data.csv",row.names=F)
...
#datafull=read.csv("C:\\Users\\John.Syslo\\Documents\\2023 Deep 7\\Raw FRS depredation\\ForGroupCpueAnalysis_gear3Step3_2020.csv") #this is now using the old data for the vessel size and day length investigation

datafull=read.csv("C:\\Users\\John.Syslo\\Documents\\2023 Deep 7\\Raw FRS depredation\\ForGroupCpueAnalysis_gear3Step3_2020_2021_data.csv")
dim(datafull)
...
dimnames(data9)[[2]][82]="uku_lbs" #dim was previously 83
####----#####
...
#SKIP WIND FOR 2021 DATA - skip to line 642
