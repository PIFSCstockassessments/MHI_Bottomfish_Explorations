    ...
    # plot & residual tests
        if(residual_flag==1)
        {
			...
			# basic QQ & residual v. predicted plot
				 	png(filename = paste0(save_dir,"dharma_agg_qq.png"),width = 16, height = 9, units = "in",res=300)
						plot(residuals_object)
					dev.off()
				# quantile test: residual v. predicted by model covariate
					png(filename = paste0(save_dir,"dharma_agg_quant_resid.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant = DHARMa::testQuantiles(residuals_object)
					dev.off()
					png(filename = paste0(save_dir,"dharma_agg_quant_resid_year.png"),width = 9, height = 9, units = "in",res=300)
					...
					dev.off()
					png(filename = paste0(save_dir,"dharma_agg_quant_resid_lon.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant_lon = DHARMa::testQuantiles(residuals_object,predictor=resid_dt$lon)
					dev.off()
					png(filename = paste0(save_dir,"dharma_agg_quant_resid_lat.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant_lat = DHARMa::testQuantiles(residuals_object,predictor=resid_dt$lat)
					dev.off()
					png(filename = paste0(save_dir,"dharma_agg_quant_resid_gear.png"),width = 9, height = 9, units = "in",res=300)
				...
				# make residual plots by factor variable
					...
					{
						png(filename = paste0(save_dir,"dharma_agg_quant_resid_",residual_factor_vec[v],".png"),width = 9, height = 9, units = "in",res=300)
					...
					{
						png(filename = paste0(save_dir,"dharma_agg_quant_resid_",residual_continuous_vec[v],".png"),width = 9, height = 9, units = "in",res=300)
				...
				# test for uniformity in residuals, overdispersion, outliers
				 	png(filename = paste0(save_dir,"dharma_agg_residual_tests.png"),width = 16, height = 9, units = "in",res=300)
						tmp_test = DHARMa::testResiduals(residuals_object)
					dev.off()
				# test for zero inflation
				 	png(filename = paste0(save_dir,"dharma_agg_test_zi.png"),width = 9, height = 9, units = "in",res=300)
						tmp_zinf = DHARMa::testZeroInflation(residuals_object)
					dev.off()
				# test for over-dispersion
				 	png(filename = paste0(save_dir,"dharma_agg_test_od.png"),width = 9, height = 9, units = "in",res=300)
				...
				# DHARMa::testSpatialAutocorrelation needs unique locations
					...
					residuals_spatial_group = DHARMa::recalculateResiduals(residuals_object, group = resid_dt$spatial_group)	
				 	png(filename = paste0(save_dir,"dharma_agg_test_spcorr.png"),width = 9, height = 9, units = "in",res=300)
				...
				# test for temporal autocorrelation
					...
					residuals_temporal_group = DHARMa::recalculateResiduals(residuals_object, group = resid_dt$temporal_group)	
				 	png(filename = paste0(save_dir,"dharma_agg_test_tcorr.png"),width = 9, height = 9, units = "in",res=300)		
...
# calc residuals by species
		...
		for(j in 1:length(u_species))
		{
			...
			# basic QQ & residual v. predicted plot
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_qq.png"),width = 16, height = 9, units = "in",res=300)
						plot(tmp_residuals)
					dev.off()
				# quantile test: residual v. predicted by model covariate
					png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant = DHARMa::testQuantiles(tmp_residuals)
					dev.off()
					png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_year.png"),width = 9, height = 9, units = "in",res=300)
					...
					dev.off()
					png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_lon.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant_lon = DHARMa::testQuantiles(tmp_residuals,predictor=tmp_bfish$lon)
					dev.off()
					png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_lat.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant_lat = DHARMa::testQuantiles(tmp_residuals,predictor=tmp_bfish$lat)
					dev.off()
                    png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_gear.png"),width = 9, height = 9, units = "in",res=300)
						tmp_quant_gear = DHARMa::testQuantiles(tmp_residuals,predictor=as.factor(tmp_bfish$gear_type))
					dev.off()
					for(v in 1:length(residual_factor_vec))
					{
                    	png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_",residual_factor_vec[v],".png"),width = 9, height = 9, units = "in",res=300)
					...
					for(v in 1:length(residual_continuous_vec))
					{
                    	png(filename = paste0(save_dir,"dharma_",u_species[j],"_quant_resid_",residual_continuous_vec[v],".png"),width = 9, height = 9, units = "in",res=300)
				...
				# test for uniformity in residuals, overdispersion, outliers
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_residual_tests.png"),width = 16, height = 9, units = "in",res=300)
						tmp_test = DHARMa::testResiduals(tmp_residuals)
					dev.off()
				# test for zero inflation
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_test_zi.png"),width = 9, height = 9, units = "in",res=300)
						tmp_zinf = DHARMa::testZeroInflation(tmp_residuals)
					dev.off()
				# test for over-dispersion
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_test_od.png"),width = 9, height = 9, units = "in",res=300)
				...
				# DHARMa::testSpatialAutocorrelation needs unique locations
					...
					tmp_residuals_spatial_group = DHARMa::recalculateResiduals(tmp_residuals, group = tmp_bfish$spatial_group)	
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_test_spcorr.png"),width = 9, height = 9, units = "in",res=300)
				...
				# test for temporal autocorrelation
					...
					tmp_residuals_temporal_group = DHARMa::recalculateResiduals(tmp_residuals, group = tmp_bfish$temporal_group)	
				 	png(filename = paste0(save_dir,"dharma_",u_species[j],"_test_tcorr.png"),width = 9, height = 9, units = "in",res=300)		
