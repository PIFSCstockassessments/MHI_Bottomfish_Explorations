...
# define dirs
  ...
  plot_dir = paste0(proj_dir,"Reports/tech_memo_v3/")
...
# plots
  ...
  p = p %>%   
	...
	ggsave(filename=paste0("index_comp_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
  ...
  p_panel2 = rbindlist(p_list2)
    p = p %>%   
      ...
      scale_fill_manual("Model",values=c(paste0("gray",30),viridis::viridis_pal(alpha = 1, begin = 0.1, end = 0.8, direction = 1, option = "H")(uniqueN(p$model_name_plot)-1))) +
      theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent"))
    ggsave(filename=paste0("index_stepwise_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
...
p = q_effect_dt %>% .[model_number==69,.(component,species_cd,variable_d,value)] %>%
 ...
 p = p %>%   
     ...
     scale_colour_manual("Model\ncomponent",values=c(paste0("gray",30),viridis::viridis_pal(alpha = 1, begin = 0.1, end = 0.8, direction = 1, option = "H")(uniqueN(p$component)-1))) +
		 theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent"))
    ggsave(filename=paste0("index_influ_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
...
plot_empirical_dt_internal = copy(plot_empirical_dt) %>%
    ...
    ggsave(filename=paste0("index_dens_covar_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
...
# discrete abundance effect
  ...
  discrete_ab_effect_dt$species_cd=factor(discrete_ab_effect_dt$species_cd,levels=deep7_code_vec,labels=deep7_name_vec)
    ...
    scale_fill_manual("Gear type",values=c("gray60","gray80")) +
	  viridis::scale_color_viridis("Model",begin = 0.1,end = 0.8,direction = 1,option = "H",discrete=TRUE)
    ggsave(filename=paste0("index_dens_covar_b.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
...
# catchability covariates
    ...
    ggsave(filename=paste0("index_q_covar_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 6, units = c("in"),
            dpi = 300, limitsize = TRUE)
...
# filter for components that are effectively "turned-off"
		...
		p = copy(predict_psu) %>%
				...
				ggthemes::theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent")) + 
	    ...
	    ggsave(filename=paste0("sp_agg_dens.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
			...
			# plot random effects distribution
			    ...
			    ggsave(filename=paste0("sp_rf_dist.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
		...
		p = copy(predict_psu) %>%
				...
				viridis::scale_color_viridis("Est. density",begin = 0.1,end = 0.8,direction = 1,option = "H",trans="log10")
	    ggsave(filename=paste0("sp_sp_dens.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
	    ...
	    ggsave(filename=paste0("sp_sp_omega.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
	    ...
	    ggsave(filename=paste0("sp_sp_eps1.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
		...
		p = copy(predict_psu) %>%
				...
				scale_color_gradient2(expression(epsilon[1]),low = "blue",mid = "gray90",high ="red",trans = trim_tails(range = c(-1,1))) 
	    ggsave(filename=paste0("sp_sp_eps2.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
	    ...
	    ggsave(filename=paste0("sp_sp_encprob.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
	    ...
	    ggsave(filename=paste0("sp_agg_encprob.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
	    ...
	    ggsave(filename=paste0("sp_sp_poscatch.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
		...
		p = copy(predict_psu) %>%
				...
				viridis::scale_color_viridis("Avg.\npositive\ncatch",begin = 0.1,end = 0.8,direction = 1,option = "H")
	    ggsave(filename=paste0("sp_agg_poscatch.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
	    ...
	    ggsave(filename=paste0("sp_sp_resid.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
		...
		p = copy(predict_psu) %>%
				...
				scale_color_gradient2("Avg.\nresidual",low = "blue",mid = "gray90",high ="red",midpoint = 0.5)
	    ggsave(filename=paste0("sp_agg_resid.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 16, height = 9, units = c("in"),
            dpi = 300, limitsize = TRUE)
  ...
  p = rbindlist(p_list)
    p = p %>%   
      ...
      scale_fill_manual("Model",values=c(paste0("gray",30),viridis::viridis_pal(alpha = 1, begin = 0.1, end = 0.8, direction = 1, option = "H")(uniqueN(p$model_name_plot)-1))) +
      theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent"))
    ggsave(filename=paste0("paka_index_stepwise_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
            scale = 1.25, width = 12, height = 6, units = c("in"),
            dpi = 300, limitsize = TRUE)
  ...
  p_list[[2]] = p[model_number %in% c(77,82,88)] %>% .[,panel:="Panel 02: Camera"]
   p = rbindlist(p_list)
    p = p %>%   
      ...
      scale_fill_manual("Model",values=c(paste0("gray",30),viridis::viridis_pal(alpha = 1, begin = 0.1, end = 0.8, direction = 1, option = "H")(uniqueN(p$model_name_plot)-1))) +
      theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent"))
    ggsave(filename=paste0("paka_index_sens_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
  ...
  p = rbindlist(p_list)
    p = p %>%   
      ...
      theme_few(base_size=20) + theme(rect = element_rect(fill="transparent"), strip.background=element_rect(fill="transparent"),panel.background=element_rect(fill="transparent"),plot.background=element_rect(fill="transparent",color=NA), legend.key = element_rect(color = "transparent", fill = "transparent"))
	ggsave(filename=paste0("index_sens_a.png"), plot = p, device = "png", bg = "transparent", path = plot_dir,
	  			scale = 1.25, width = 12, height = 9, units = c("in"),
	  			dpi = 300, limitsize = TRUE)
