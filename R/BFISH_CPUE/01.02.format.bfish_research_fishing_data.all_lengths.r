...
# bring in research fishing data
	...
	# save formatted data
		save(BFISH_D,file=paste0(proj.dir,"Data/",data_flag,"BFISH_D.all_lengths.RData"))
		save(BFISH_S,file=paste0(proj.dir,"Data/",data_flag,"BFISH_S.all_lengths.RData"))
		save(BFISH_C,file=paste0(proj.dir,"Data/",data_flag,"BFISH_C.all_lengths.RData"))
		save(research_fishing_dt,file=paste0(proj.dir,"Data/",data_flag,"research_fishing_dt.all_lengths.RData"))
