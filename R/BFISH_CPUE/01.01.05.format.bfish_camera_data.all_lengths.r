...
# bring in camera data
	...
	fwrite(unique(camera_dt[,.(DROP_CD)]),file=paste0(proj.dir,"Data/",data_flag,"05.camera_dt.all_lengths.drop_cd.csv"))
	...
	# save formatted data
		save(camera_dt,file=paste0(proj.dir,"Data/",data_flag,"05.camera_dt.all_lengths.RData"))
