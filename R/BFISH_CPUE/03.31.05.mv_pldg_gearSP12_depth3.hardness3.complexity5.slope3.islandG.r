...
# specify (coarse) model configuration
    ...
    abundance_covariates = "depth3.hardness3.complexity5.slope3.islandG" # vanilla
    lehi_filter = TRUE
...
# 1) bring in data
	...
	# define abundance section
		...
		ab1_formula = ~ bs(depth_sc,df=3) + bs(hardness_sc,df=3) + bs(complexity_sc,df=5) + bs(slope_sc,df=3) + islandG
        ab2_formula = ~ 0
