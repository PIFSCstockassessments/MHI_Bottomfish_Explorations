...
# specify (coarse) model configuration
    ...
    species = "mv"
    data_treatment = "01"
    catchability_covariates = "gearSP.monthSP" # vanilla
...
# set working directory
    ...
    load_spatial_path = paste0(proj.dir,"VAST/model_runs/2022-12-28/2021_pldg_mv_01_v_v_TRUE_7.5_FALSE_TRUE_pit_noxval/")
	# xval path
