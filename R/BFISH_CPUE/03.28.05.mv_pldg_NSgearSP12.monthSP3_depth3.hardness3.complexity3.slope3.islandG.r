...
# specify (coarse) model configuration
    ...
    species = "mv"
    data_treatment = "05"
    catchability_covariates = "NSgearSP12.monthSP3" # vanilla
...
# set working directory
    ...
    load_spatial_path = paste0(proj.dir,"VAST/model_runs/2023-06-09/2022_pldg_mv_05_NSgearSP12_depth3.hardness3.complexity3.slope3.islandG_TRUE_7.5_TRUE_TRUE_pit_noxval/")
	# xval path
...
# 1) bring in data
	...
	# remove spring samples
		bfish_df = subset(bfish_df, !(month %in% c("02","03")))
