...
```{r setup, include=FALSE}
	...
	# bring in data
		...
		deep7_code_vec = c("ETCA","APRU","PRSI","HYQU","PRFI","PRZO","ETCO")
		deep7_name_vec = c("Ehu", "Lehi", "Kalekale", "Hapuupuu", "Opakapaka", "Gindai", "Onaga")
```
Research fishing makes up one of the two survey sampling gears used in the Bottomfish Fishery independent Survey in the Main Hawaiian Islands (BFISH). A standard research fishing sample was conducted at each primary sampling unit (PSU) that was allocated to the research fishing gear as a part of the stratified random sampling design process. A standard research fishing sample consisted of 30 minutes of active hook and line fishing within the PSU by one vessel using two lines. Each line was fished with four hooks and two bait types, squid and fish. Catch is reported in terms of kilograms (kg) where the weight of the catch was determined using the species length and allometric relationship. More information on how this data is incorporated into the stock assessment can be found [here](https://www.fisheries.noaa.gov/species/main-hawaiian-islands-deep-7-bottomfish#overview).
...
```{r warning=FALSE}
	cols = c("SAMPLE_ID","BAIT_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	...
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
...
```
```{r warning=FALSE}
	cols = c("SAMPLE_ID","BAIT_CD","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_01, warning=FALSE}
	cols = c("YEAR","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_03, warning=FALSE}
	cols = c("YEAR","BAIT_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_04, warning=FALSE}
	cols = c("YEAR","BAIT_CD","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_05, warning=FALSE}
	cols = c("JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_06, warning=FALSE}
	cols = c("JD","MONTH","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_07, warning=FALSE}
	cols = c("LUNAR_PHASE",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_08, warning=FALSE}
	cols = c("LUNAR_PHASE","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
...
```{r e_09, warning=FALSE}
	cols = c("LUNAR_PHASE","JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
...
```{r e_10, warning=FALSE}
	cols = c("VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_11, warning=FALSE}
	cols = c("Island","VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_12, warning=FALSE}
	cols = c("CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_13, warning=FALSE}
	cols = c("Island","CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_14, warning=FALSE}
	cols = c("TIME_MIN",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_15, warning=FALSE}
	cols = c("TIME_MIN","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,TIME_MIN:=floor(TIME_MIN)] %>%
...
```{r e_16, warning=FALSE}
	cols = c("DEPTH_M",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_17, warning=FALSE}
	cols = c("DEPTH_M","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_18, warning=FALSE}
	cols = c("LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_19, warning=FALSE}
	cols = c("Island","LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LON:=floor(LON/0.25)*0.25] %>%
...
```{r e_20, warning=FALSE}
	cols = c("LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_21, warning=FALSE}
	cols = c("Island","LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LAT:=floor(LAT/0.25)*0.25] %>%
...
```{r e_22, warning=FALSE}
	cols = c("STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r e_23, warning=FALSE}
	cols = c("Island","STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
...
```{r p_01, warning=FALSE}
	cols = c("YEAR","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","Island")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(YEAR,variable)] %>%
	.[,YEAR:=as.numeric(YEAR)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Year") + ylab("Positive catch (kg)") +
    geom_path(aes(x = YEAR, y=value, color = variable),size=1,alpha=0.5) +
    geom_point(aes(x = YEAR, y=value, fill = variable),shape=21,color="black",size=1.25) +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~ variable, scales = "free") +
    scale_color_nmfs(name="Species",palette="regional web") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_02, warning=FALSE}
	cols = c("YEAR","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","Island")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(YEAR,Island,variable)] %>%
	.[,YEAR:=as.numeric(YEAR)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
    ...
    scale_color_nmfs(name="Species",palette="regional web") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_03, warning=FALSE}
	cols = c("YEAR","BAIT_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","BAIT_CD")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(YEAR,BAIT_CD,variable)] %>%
	.[,YEAR:=as.numeric(YEAR)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,BAIT_CD:=factor(BAIT_CD,levels=c("F","S"),labels=c("Fish","Squid"))] %>%
	ggplot() +
	xlab("Year") + ylab("Positive catch (kg)") +
	scale_x_continuous(breaks=c(2017,2019)) +
    geom_path(aes(x = YEAR, y=value, color = BAIT_CD),size=1,alpha=0.5) +
    geom_point(aes(x = YEAR, y=value, fill = BAIT_CD),shape=21,color="black",size=1.25) +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~variable, scales = "free") +
    scale_color_nmfs(name="Bait type",palette="regional web") +
    scale_fill_nmfs(name="Bait type",palette="regional web") +
    labs(title = "Positive catch by species.")
```


```{r p_04, warning=FALSE}
	cols = c("YEAR","BAIT_CD","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","BAIT_CD","Island")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(YEAR,BAIT_CD,Island,variable)] %>%
	.[,YEAR:=as.numeric(YEAR)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,BAIT_CD:=factor(BAIT_CD,levels=c("F","S"),labels=c("Fish","Squid"))] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	...
	scale_color_nmfs(name="Bait type",palette="regional web") +
    scale_fill_nmfs(name="Bait type",palette="regional web") +
    labs(title = "Positive catch by species, bait type, and island group.")
```

```{r p_05, warning=FALSE}
	cols = c("JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("JD","MONTH")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(JD,MONTH,variable)] %>%
	.[,JD:=as.numeric(JD)] %>%
	.[,MONTH:=as.numeric(MONTH)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,MONTH:=factor(as.character(MONTH),levels=as.character(1:12),labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"))] %>%
	ggplot() +
	xlab("Month") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("Feb","May","Aug","Nov"),drop=FALSE) +
    geom_boxplot(aes(x = MONTH, y=value, fill = variable),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~variable, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and month.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_06, warning=FALSE}
	cols = c("JD","MONTH","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("JD","MONTH","Island")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(JD,MONTH,Island,variable)] %>%
	.[,JD:=as.numeric(JD)] %>%
	.[,MONTH:=as.numeric(MONTH)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,MONTH:=factor(as.character(MONTH),levels=as.character(1:12),labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"))] %>%
    ...
    facet_grid(variable~Island, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, month, and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_07, warning=FALSE}
	cols = c("LUNAR_PHASE",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
	melt(.,id.vars=c("LUNAR_PHASE_BIN","LUNAR_PHASE")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(LUNAR_PHASE_BIN,LUNAR_PHASE,variable)] %>%
	.[,LUNAR_PHASE_BIN:=factor(as.character(LUNAR_PHASE_BIN),levels=as.character(seq(from=0,by=0.125,to=1)))] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Lunar illumination") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=as.character(c(0,0.25,0.5,0.75,1)),drop=FALSE) +
    geom_boxplot(aes(x = LUNAR_PHASE_BIN, y=value, fill = variable),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~variable, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and degree of lunar illumination.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_08, warning=FALSE}
	cols = c("LUNAR_PHASE","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
	melt(.,id.vars=c("Island","LUNAR_PHASE_BIN","LUNAR_PHASE")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE)),by=.(Island,LUNAR_PHASE_BIN,LUNAR_PHASE,variable)] %>%
	.[,LUNAR_PHASE_BIN:=factor(as.character(LUNAR_PHASE_BIN),levels=as.character(seq(from=0,by=0.125,to=1)))] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
    ...
    facet_grid(variable~Island, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, degree of lunar illumination, and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_09, warning=FALSE}
	cols = c("LUNAR_PHASE","JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
	melt(.,id.vars=c("MONTH","JD","LUNAR_PHASE_BIN","LUNAR_PHASE")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(MONTH,LUNAR_PHASE_BIN,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,MONTH:=as.numeric(MONTH)] %>%
	.[,MONTH:=factor(as.character(MONTH),levels=as.character(1:12),labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, degree of lunar illumination, and month.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_10, warning=FALSE}
	cols = c("VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("VESSEL")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(VESSEL,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,VESSEL:=as.numeric(as.factor(VESSEL))] %>%
	ggplot() +
	xlab("Vessel ID") + ylab("Positive catch (kg)") +
	scale_x_continuous(breaks=c(1,5,10,15)) +
    geom_segment(aes(x = VESSEL,xend=VESSEL,y=0, yend=value, color = variable)) +
    geom_point(aes(x = VESSEL, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and Vessel ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_11, warning=FALSE}
	cols = c("Island","VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","VESSEL")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,VESSEL,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,VESSEL:=as.numeric(as.factor(VESSEL))] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, island group, and Vessel ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_12, warning=FALSE}
	cols = c("CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("CAPTAIN_CD")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(CAPTAIN_CD,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,CAPTAIN_CD:=as.numeric(as.factor(CAPTAIN_CD))] %>%
	ggplot() +
	xlab("Captain ID") + ylab("Positive catch (kg)") +
	scale_x_continuous(breaks=c(1,5,10)) +
    geom_segment(aes(x = CAPTAIN_CD,xend=CAPTAIN_CD,y=0, yend=value, color = variable)) +
    geom_point(aes(x = CAPTAIN_CD, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and Captain ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_13, warning=FALSE}
	cols = c("Island","CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","CAPTAIN_CD")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,CAPTAIN_CD,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,CAPTAIN_CD:=as.numeric(as.factor(CAPTAIN_CD))] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, island group, and Captain ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_14, warning=FALSE}
	cols = c("TIME_MIN",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,TIME_MIN:=floor(TIME_MIN)] %>%
	melt(.,id.vars=c("TIME_MIN")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(TIME_MIN,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,TIME_MIN:=factor(as.character(TIME_MIN),levels=as.character(0:24))] %>%
	ggplot() +
	xlab("Time of day") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("6","12","18"),drop=FALSE) +
    geom_segment(aes(x = TIME_MIN,xend=TIME_MIN,y=0, yend=value, color = variable)) +
    geom_point(aes(x = TIME_MIN, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and time of day.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_15, warning=FALSE}
	cols = c("TIME_MIN","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,TIME_MIN:=floor(TIME_MIN)] %>%
	melt(.,id.vars=c("Island","TIME_MIN")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,TIME_MIN,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,TIME_MIN:=factor(as.character(TIME_MIN),levels=as.character(0:24))] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, time of day, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_16, warning=FALSE}
	cols = c("DEPTH_M",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,DEPTH_M:=floor(DEPTH_M/50)*50] %>%
	melt(.,id.vars=c("DEPTH_M")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(DEPTH_M,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,DEPTH_M:=factor(as.character(DEPTH_M),levels=as.character(seq(from=0,to=450,by=50)))] %>%
	ggplot() +
	xlab("Depth (m)") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("100","200","300"),drop=FALSE) +
    geom_segment(aes(x = DEPTH_M,xend=DEPTH_M,y=0, yend=value, color = variable)) +
    geom_point(aes(x = DEPTH_M, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and depth.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_17, warning=FALSE}
	cols = c("DEPTH_M","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,DEPTH_M:=(floor(DEPTH_M/50)*50)/100] %>%
	melt(.,id.vars=c("Island","DEPTH_M")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,DEPTH_M,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,DEPTH_M:=factor(as.character(DEPTH_M),levels=as.character(seq(from=0,to=4.50,by=0.50)))] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
	xlab("Depth (100 m)") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("1","2","3"),drop=FALSE) +
    geom_segment(aes(x = DEPTH_M,xend=DEPTH_M,y=0, yend=value, color = variable)) +
    geom_point(aes(x = DEPTH_M, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, depth, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_18, warning=FALSE}
	cols = c("LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LON:=floor(LON/0.25)*0.25] %>%
	melt(.,id.vars=c("LON")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(LON,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,LON:=factor(as.character(LON),levels=as.character(seq(from=-160.5,to=-154,by=0.250)))] %>%
	ggplot() +
	xlab("Longitude") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("-158","-156","-154"),drop=FALSE) +
    geom_segment(aes(x = LON,xend=LON,y=0, yend=value, color = variable)) +
    geom_point(aes(x = LON, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and longitude.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_19, warning=FALSE}
	cols = c("Island","LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LON:=floor(LON/0.25)*0.25] %>%
	melt(.,id.vars=c("Island","LON")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,LON,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	.[,LON:=factor(as.character(LON),levels=as.character(seq(from=-160.5,to=-154,by=0.250)))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, longitude, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_20, warning=FALSE}
	cols = c("LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LAT:=floor(LAT/0.25)*0.25] %>%
	melt(.,id.vars=c("LAT")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(LAT,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,LAT:=factor(as.character(LAT),levels=as.character(seq(from=18.5,to=22.5,by=0.250)))] %>%
	ggplot() +
	xlab("Latitude") + ylab("Positive catch (kg)") +
	scale_x_discrete(breaks=c("19","20","21"),drop=FALSE) +
    geom_segment(aes(x = LAT,xend=LAT,y=0, yend=value, color = variable)) +
    geom_point(aes(x = LAT, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and latitude.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_21, warning=FALSE}
	cols = c("Island","LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LAT:=floor(LAT/0.25)*0.25] %>%
	melt(.,id.vars=c("Island","LAT")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,LAT,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	.[,LAT:=factor(as.character(LAT),levels=as.character(seq(from=18.5,to=22.5,by=0.250)))] %>%
	ggplot() +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, latitude, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r p_22, warning=FALSE}
	cols = c("STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("STRATA")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(STRATA,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Survey strata") + ylab("Positive catch (kg)") +
    geom_segment(aes(x = STRATA,xend=STRATA,y=0, yend=value, color = variable)) +
    geom_point(aes(x = STRATA, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species and survey strata.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r p_23, warning=FALSE}
	cols = c("Island","STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","STRATA")) %>%
	.[value==0,value:=NA] %>%
	.[,.(value=mean(value,na.rm=TRUE),.N),by=.(Island,STRATA,variable)] %>%
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
	xlab("Survey strata") + ylab("Positive catch (kg)") +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Positive catch by species, survey strata, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```
...
```{r n_01, warning=FALSE}
	...
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Year") + ylab("Nominal CPUE (kg)") +
    geom_path(aes(x = YEAR, y=value, color = variable),size=1,alpha=0.5) +
    geom_point(aes(x = YEAR, y=value, fill = variable),shape=21,color="black",size=1.25) +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    ...
    scale_color_nmfs(name="Species",palette="regional web") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_02, warning=FALSE}
	cols = c("YEAR","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","Island")) %>%
    ...
    scale_color_nmfs(name="Species",palette="regional web") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_03, warning=FALSE}
	cols = c("YEAR","BAIT_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("YEAR","BAIT_CD")) %>%
...
```{r n_04, warning=FALSE}
	...
	scale_color_nmfs(name="Bait type",palette="regional web") +
    scale_fill_nmfs(name="Bait type",palette="regional web") +
    labs(title = "Nominal CPUE by species, bait type, and island group.")
```

```{r n_05, warning=FALSE}
	cols = c("JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("JD","MONTH")) %>%
	...
	.[,MONTH:=factor(as.character(MONTH),levels=as.character(1:12),labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"))] %>%
	ggplot() +
	xlab("Month") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("Feb","May","Aug","Nov"),drop=FALSE) +
    geom_boxplot(aes(x = MONTH, y=value, fill = variable),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~variable, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and month.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_06, warning=FALSE}
	cols = c("JD","MONTH","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("JD","MONTH","Island")) %>%
    ...
    facet_grid(variable~Island, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, month, and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_07, warning=FALSE}
	cols = c("LUNAR_PHASE",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
	...
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Lunar illumination") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=as.character(c(0,0.25,0.5,0.75,1)),drop=FALSE) +
    geom_boxplot(aes(x = LUNAR_PHASE_BIN, y=value, fill = variable),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    facet_wrap(~variable, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and degree of lunar illumination.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_08, warning=FALSE}
	cols = c("LUNAR_PHASE","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
    ...
    facet_grid(variable~Island, scales = "free") +
    scale_fill_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, degree of lunar illumination, and island group.",
         caption = "Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_09, warning=FALSE}
	cols = c("LUNAR_PHASE","JD","MONTH",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LUNAR_PHASE_BIN:=floor(LUNAR_PHASE/0.125)*0.125] %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, degree of lunar illumination, and month.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_10, warning=FALSE}
	cols = c("VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("VESSEL")) %>%
	...
	.[,VESSEL:=as.numeric(as.factor(VESSEL))] %>%
	ggplot() +
	xlab("Vessel ID") + ylab("Nominal CPUE (kg)") +
	scale_x_continuous(breaks=c(1,5,10,15)) +
    geom_segment(aes(x = VESSEL,xend=VESSEL,y=0, yend=value, color = variable)) +
    geom_point(aes(x = VESSEL, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and Vessel ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_11, warning=FALSE}
	cols = c("Island","VESSEL",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","VESSEL")) %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, island group, and Vessel ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_12, warning=FALSE}
	cols = c("CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("CAPTAIN_CD")) %>%
	...
	.[,CAPTAIN_CD:=as.numeric(as.factor(CAPTAIN_CD))] %>%
	ggplot() +
	xlab("Captain ID") + ylab("Nominal CPUE (kg)") +
	scale_x_continuous(breaks=c(1,5,10)) +
    geom_segment(aes(x = CAPTAIN_CD,xend=CAPTAIN_CD,y=0, yend=value, color = variable)) +
    geom_point(aes(x = CAPTAIN_CD, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and Captain ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_13, warning=FALSE}
	cols = c("Island","CAPTAIN_CD",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","CAPTAIN_CD")) %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, island group, and Captain ID.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_14, warning=FALSE}
	cols = c("TIME_MIN",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,TIME_MIN:=floor(TIME_MIN)] %>%
	...
	.[,TIME_MIN:=factor(as.character(TIME_MIN),levels=as.character(0:24))] %>%
	ggplot() +
	xlab("Time of day") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("6","12","18"),drop=FALSE) +
    geom_segment(aes(x = TIME_MIN,xend=TIME_MIN,y=0, yend=value, color = variable)) +
    geom_point(aes(x = TIME_MIN, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and time of day.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_15, warning=FALSE}
	cols = c("TIME_MIN","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,TIME_MIN:=floor(TIME_MIN)] %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, time of day, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_16, warning=FALSE}
	cols = c("DEPTH_M",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,DEPTH_M:=floor(DEPTH_M/50)*50] %>%
	...
	.[,DEPTH_M:=factor(as.character(DEPTH_M),levels=as.character(seq(from=0,to=450,by=50)))] %>%
	ggplot() +
	xlab("Depth (m)") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("100","200","300"),drop=FALSE) +
    geom_segment(aes(x = DEPTH_M,xend=DEPTH_M,y=0, yend=value, color = variable)) +
    geom_point(aes(x = DEPTH_M, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and depth.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_17, warning=FALSE}
	cols = c("DEPTH_M","Island",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,DEPTH_M:=(floor(DEPTH_M/50)*50)/100] %>%
	...
	.[,Island:=factor(Island,levels=c("Niihau","Kauai","Oahu","Maui Nui","Big Island"),labels=c("Niihau","Kauai","Oahu","Maui Nui","Hawaii"))] %>%
	ggplot() +
	xlab("Depth (100 m)") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("1","2","3"),drop=FALSE) +
    geom_segment(aes(x = DEPTH_M,xend=DEPTH_M,y=0, yend=value, color = variable)) +
    geom_point(aes(x = DEPTH_M, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, depth, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_18, warning=FALSE}
	cols = c("LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LON:=floor(LON/0.25)*0.25] %>%
	...
	.[,LON:=factor(as.character(LON),levels=as.character(seq(from=-160.5,to=-154,by=0.250)))] %>%
	ggplot() +
	xlab("Longitude") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("-158","-156","-154"),drop=FALSE) +
    geom_segment(aes(x = LON,xend=LON,y=0, yend=value, color = variable)) +
    geom_point(aes(x = LON, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and longitude.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_19, warning=FALSE}
	cols = c("Island","LON",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LON:=floor(LON/0.25)*0.25] %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, longitude, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_20, warning=FALSE}
	cols = c("LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LAT:=floor(LAT/0.25)*0.25] %>%
	...
	.[,LAT:=factor(as.character(LAT),levels=as.character(seq(from=18.5,to=22.5,by=0.250)))] %>%
	ggplot() +
	xlab("Latitude") + ylab("Nominal CPUE (kg)") +
	scale_x_discrete(breaks=c("19","20","21"),drop=FALSE) +
    geom_segment(aes(x = LAT,xend=LAT,y=0, yend=value, color = variable)) +
    geom_point(aes(x = LAT, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and latitude.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_21, warning=FALSE}
	cols = c("Island","LAT",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	.[,LAT:=floor(LAT/0.25)*0.25] %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, latitude, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```


```{r n_22, warning=FALSE}
	cols = c("STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("STRATA")) %>%
	...
	.[,variable:=factor(variable,levels=deep7_code_vec,labels=deep7_name_vec)] %>%
	ggplot() +
	xlab("Survey strata") + ylab("Nominal CPUE (kg)") +
    geom_segment(aes(x = STRATA,xend=STRATA,y=0, yend=value, color = variable)) +
    geom_point(aes(x = STRATA, y=value, fill = variable,size=N),shape=21,color="black") +
    geom_hline(yintercept = 0) +
    theme_classic(base_size = 10) +
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species and survey strata.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```

```{r n_23, warning=FALSE}
	cols = c("Island","STRATA",deep7_code_vec)
	research_fishing_dt %>%
	.[,cols,with=FALSE] %>%
	melt(.,id.vars=c("Island","STRATA")) %>%
    ...
    scale_fill_nmfs(name="Species",palette="regional web") +
    scale_color_nmfs(name="Species",palette="regional web") +
    labs(title = "Nominal CPUE by species, survey strata, and island group.",
         caption = "Circle size represents the number of fishing sets. \n Note: Catch is recorded seperately by bait type within the same sample.")
```