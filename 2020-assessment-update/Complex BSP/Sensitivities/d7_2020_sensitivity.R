...
q_lo <- 0.00001    #reduce by 00 to avoid undefined real,tau2=100 
q_hi <- 100000     #reduce by 00 to avoid undefined real,tau2=100
...
inits <- list(    # create inits list of functions
  ...
  list(
    ...
    isigma2=100,  #changed form 100 to 10 for sigma = 10 scenario - undefined real
